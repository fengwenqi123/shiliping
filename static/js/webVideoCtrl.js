  ...
  if (!e.WebVideoCtrl) {
    var t = function () {
      ...
      var n = "100%", r = "100%", o = "", i = "", a = {
          ...
          cbSelWnd: null,
          cbEvent: null
        }, c = null, u = 0, l = [], p = [], d = null, P = null, h = null, I = null, f = this, m = null, C = 1, S = 2,
        y = 200, g = 0, v = 1, x = 2, T = 3, z = 4, D = 5, A = 6, b = 0, M = 2, q = 3, L = 21, R = 0, G = "IPCamera",
        X = "IPDome", H = "IPZoom",
      ...
      this.I_Login = function (e, t, s, n, r, o) {
        ...
        var n = this.findDeviceIndexByIP(e), r = -1, o = "", i = "", a = -1, c = -1,
          p = I.dateFormat(new Date, "yyyy-MM-dd"),
          d = {iWndIndex: u, iChannelID: 1, bZeroChannel: !1, szStartTime: p + " 00:00:00", szEndTime: p + " 23:59:59"};
        if (I.extend(d, t), -1 != n) {
          j(l[n]);
          var P = l[n], h = parseInt(s.$XML(m).find("ProtocolType").eq(0).text(), 10);
      ...
      tt.prototype.CGI = {
        ...
        var c = new et, u = {type: "PUT", url: o, async: !1, auth: e.szAuth, data: i, success: null, error: null},
          l = this;
        ...
        var s = t.iWndIndex, n = t.szStartTime, r = t.szEndTime,
          o = k(t.cgi, t.urlProtocol, e.szIP, t.iPort, t.iChannelID, n, r), i = c.HWP_ReversePlay(o, e.szAuth, s, n, r);
        if (0 == i) {
          var a = new Q;
        ...
        var a = I.loadXML(n), c = parseInt(s.$XML(a).find("StartPoint").eq(0).find("positionX").eq(0).text(), 10),
      ...
      st.prototype.CGI = {
        ...
        var s = t.iWndIndex, n = t.szStartTime, r = t.szEndTime,
          o = k(t.cgi, t.urlProtocol, e.szIP, t.iPort, t.iChannelID, n, r), i = c.HWP_Play(o, e.szAuth, s, n, r);
        if (0 == i) {
          var a = new Q;
      ...
      rt.prototype.extend = function () {
        ...
        var e = /(webkit)[ \/]([\w.]+)/, t = /(opera)(?:.*version)?[ \/]([\w.]+)/, s = /(msie) ([\w.]+)/,
          n = /(trident.*rv:)([\w.]+)/, r = /(mozilla)(?:.*? rv:([\w.]+))?/, o = navigator.userAgent.toLowerCase(),
        ...
        var e = new Date(1582, 10, 15, 0, 0, 0, 0), s = new Date, n = s.getTime() - e.getTime(), r = "-",
          o = t.getIntegerBits(n, 0, 31), i = t.getIntegerBits(n, 32, 47), a = t.getIntegerBits(n, 48, 59) + "1",
