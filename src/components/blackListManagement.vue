      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <p class="nei" @click="openDetails(scope.row)">{{scope.row.license}}</p>
          </template>
        </el-table-column>
        <el-table-column
          prop="description"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      <p><span class="font">原因:</span><span>${row.description}</span></p>
      ...
      getAuth: function () {
        var _this = this
        $.ajax({
          url: _this.apiUrl + 'blacklist/?time=' + new Date().getTime(),
          type: 'GET',
          dataType: 'json',
          data: {
