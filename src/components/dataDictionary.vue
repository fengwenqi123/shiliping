      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <p class="nei" @click="openDetails(scope.row)">{{scope.row.classification}}</p>
          </template>
        </el-table-column>
        <el-table-column
          prop="itemName"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      <p><span class="font">选项名:</span><span>${row.itemName}</span></p>
      <p><span class="font">选项值:</span><span>${row.itemValue}</span></p>
      ...
      getAuth: function () {
        var _this = this
        $.ajax({
          url: _this.apiUrl + 'dataDictionary/list/?time=' + new Date().getTime(),
          type: 'GET',
          dataType: 'json',
          data: {
      ...
      modify() {
        ...
        this.$router.push({
          ...
          params: {
            id: this.mul[0].id,
            classification: this.mul[0].classification,
            itemName: this.mul[0].itemName,
            itemValue: this.mul[0].itemValue,
            sort: this.mul[0].sort,
            type: this.mul[0].type,
      ...
      del() {
        ...
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          var _this = this
          $.ajax({
            url: _this.apiUrl + 'dataDictionary/remove',
            type: 'PUT',
            dataType: 'json',
            data: {
              id: num
      ...
      Enable() {
        ...
        this.$confirm('此操作即将启动, 是否继续?', '提示', {
          ...
          var _this = this
          $.ajax({
            url: _this.apiUrl + 'dataDictionary/enable',
            type: 'PUT',
            dataType: 'json',
            data: {
              id: num
      ...
      disEnable() {
        ...
        this.$confirm('此操作即将启动, 是否继续?', '提示', {
          ...
          var _this = this
          $.ajax({
            url: _this.apiUrl + 'dataDictionary/disable',
            type: 'PUT',
            dataType: 'json',
            data: {
              id: num
