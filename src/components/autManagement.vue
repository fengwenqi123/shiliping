  ...
  export default {
    ...
    methods: {
      ...
      getAuth: function () {
        var _this = this
        $.ajax({
          url: _this.apiUrl + 'authorize/?time=' + new Date().getTime(),
          type: 'GET',
          dataType: 'json',
          data: {
      ...
      modify() {
        ...
        this.$router.push({
          ...
          params: {
            id: this.mul[0].id,
            actionValue: this.mul[0].actionValue,
        ...
        // this.$router.push({
        //   path: '/perModification_mod/' + this.mul[0].actionValue + '/' + this.mul[0].id + '/' + this.mul[0].layer.split('100')[0] + '/' + this.mul[0].name + '/' + this.mul[0].sort + '/' + this.mul[0].description + '/' + this.mul[0].status
        // })
      },
      // 删除
      del() {
        ...
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          var _this = this
          $.ajax({
            url: _this.apiUrl + 'authorize/remove',
            type: 'PUT',
            dataType: 'json',
            data: {
              id: num
      ...
      Enable() {
        ...
        this.$confirm('此操作即将启动, 是否继续?', '提示', {
          ...
          var _this = this
          $.ajax({
            url: _this.apiUrl + 'authorize/enable',
            type: 'PUT',
            dataType: 'json',
            data: {
              id: num
      ...
      disEnable() {
        ...
        this.$confirm('此操作即将启动, 是否继续?', '提示', {
          ...
          var _this = this
          $.ajax({
            url: _this.apiUrl + 'authorize/disable',
            type: 'PUT',
            dataType: 'json',
            data: {
              id: num
