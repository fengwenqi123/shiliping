<template>
  <!--车辆历史登记信息-->
  <div class="historicalManagement">
    <el-breadcrumb separator="/">
      <el-breadcrumb-item :to="{ path: '/' }">首页</el-breadcrumb-item>
      <el-breadcrumb-item>车辆管理</el-breadcrumb-item>
      <el-breadcrumb-item>车辆历史登记信息管理</el-breadcrumb-item>
    </el-breadcrumb>
    <hr>
      ...
      <el-table
        ...
        >
          <template slot-scope="scope">
            <p class="nei" @click="openDetails(scope.row)">{{scope.row.carLicense}}</p>
          </template>
        </el-table-column>
        <el-table-column
          prop="pilot"
  ...
  export default {
    ...
    methods: {
      ...
      getAuth: function () {
        var _this = this
        $.ajax({
          url: _this.apiUrl + 'visitorHistoryInfo/?time=' + new Date().getTime(),
          type: 'GET',
          dataType: 'json',
          data: {
      ...
      del() {
        ...
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          var _this = this
          $.ajax({
            url: _this.apiUrl + 'blacklist/remove',
            type: 'PUT',
            dataType: 'json',
            data: {
              id: num
