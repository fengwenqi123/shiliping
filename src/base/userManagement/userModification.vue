  ...
  export default {
    ...
    methods: {
      ...
      getQuery() {
        ...
        this.gender = this.$route.params.gender ? this.$route.params.gender.toString() : '1'
        this.value2 = this.$route.params.birthday
      ...
      save() {
        ...
        console.log(this.checkList1.join(','))
        if (!this.loginName) {
          alert('请先填写登录名！')
          return
        }
        ...
        $.ajax({
          ...
          data: {
            ...
            roleIds: _this.checkList.join(','),
            departmentIds: _this.checkList1.join(',')
          },
          headers: {
            accessToken: _this.token
          },
